...
public interface IServiceRepository
{
    ...
    ValueTask<Service?> GetByIdAsync(Guid clientId, QueryOptions queryOptions = default,
    ...
    ValueTask<Service?> DeleteByIdAsync(Guid clientId, CommandOptions commandOptions,
        CancellationToken cancellationToken = default);
}