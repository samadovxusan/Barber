...
public class IdentityTokenGeneratorService(IConfiguration configuration, AppDbContext context)
    : IIdentityTokenGeneratorService
{
    ...
    public async Task<string> GenerateTokenAsync(IEnumerable<Claim> additionalClaims)
    {
    ...
    public async ValueTask<string> GenerateRefreshTokenAsync()
    {
